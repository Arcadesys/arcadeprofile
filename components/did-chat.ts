export function renderDidChat() {
    return `
        ...
        <style>
            ...
            .twilight-chat .chat-box {
                flex-direction: row-reverse;
                justify-content: flex-end;
                margin-right: 0;
            }

            .twilight-chat .message-wrapper {
                align-items: flex-end;
            }

            .twilight-chat .message {
                text-align: right;
            }
            ...
            .sam-chat p {
                background-color: #600261;
                align-self: flex-start;
            }

            .addie-chat p {
                background-color: #e118b9;
                align-self: flex-start;
            }

            .lucy-chat p {
                background-color: #e22b07;
                align-self: flex-start;
            }
        ...
        <script>
            ...
            function populateChat() {
                ...
                if (chatContainer) {
                    chatContainer.innerHTML = messages.map(generateMessageHTML).join('');
                }
            }
