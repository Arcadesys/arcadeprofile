...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "posts" (
  	...
  	"publish_status" "enum_posts_publish_status" DEFAULT 'draft',
  	"scheduled_publish_date" timestamp(3) with time zone,
  	"group" varchar,
  	"order" numeric,
  	"author" varchar DEFAULT 'Austen Tucker',
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_publish_status" "enum__posts_v_version_publish_status" DEFAULT 'draft',
  	"version_scheduled_publish_date" timestamp(3) with time zone,
  	"version_group" varchar,
  	"version_order" numeric,
  	"version_author" varchar DEFAULT 'Austen Tucker',
  ...
  CREATE TABLE "books" (
  	...
  	"cover_image" varchar,
  	"buy_link" varchar,
  	"has_buy_button" boolean DEFAULT false,
  ...
  ALTER TABLE "groups_tags" ADD CONSTRAINT "groups_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."groups"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "groups_tags_order_idx" ON "groups_tags" USING btree ("_order");
  CREATE INDEX "groups_tags_parent_id_idx" ON "groups_tags" USING btree ("_parent_id");
  ...
  CREATE UNIQUE INDEX "books_key_idx" ON "books" USING btree ("key");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "groups_tags" CASCADE;
  ...
  DROP TYPE "public"."enum_posts_publish_status";
  DROP TYPE "public"."enum_posts_status";
  DROP TYPE "public"."enum__posts_v_version_publish_status";
