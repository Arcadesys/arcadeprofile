          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <tbody>
              <tr>
                ...
                <td style={{ padding: "10px", borderBottom: "1px solid #ddd" }}>
                  <p>I'm a published author who mostly writes YA fantasy. Check out my catalog <Link href="/previews" className="text-link">here</Link>.</p>
                </td>
              </tr>
              <tr>
                <td style={{ padding: "10px", borderBottom: "1px solid #ddd" }}>
                ...
                <td style={{ padding: "10px", borderBottom: "1px solid #ddd" }}>
                  <p>I'm a full stack developer mostly working in Python, Javascript, and Next.js. My passion is building useful tools for the neurodivergent and blind communities. Check out my projects <Link href="/projects" className="text-link">here</Link>.</p>
                </td>
              </tr>
              <tr>
                <td style={{ padding: "10px", borderBottom: "1px solid #ddd" }}>
