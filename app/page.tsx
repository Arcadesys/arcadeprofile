  ...
  <div className="austenbox" style={{ margin: "0 auto", marginTop: "5%", marginBottom: "5%" }}>
    <div className="intro-content">
      ...
      <div className="intro-text">
        <h1 className="gaysparkles" style={{ textAlign: "center" }}>
        ...
        <div className="arcadetext" style={{ textAlign: "left" }}>
          <section style={{ padding: "1rem 0", borderBottom: "1px solid var(--border)" }}>
            <h2 style={{ marginBottom: "0.5rem" }}>Books</h2>
            <p>
              Published author, mostly YA fantasy. Not represented right now, but open to it. Catalog and previews <Link href="/previews" className="text-link">here</Link>.
            </p>
          </section>
          <section style={{ padding: "1rem 0", borderBottom: "1px solid var(--border)" }}>
            <h2 style={{ marginBottom: "0.5rem" }}>Web & apps</h2>
            <p>
              Full stack — Python, JavaScript, Next.js. We like building stuff that's actually useful for neurodivergent and blind folks. Projects and rambles on the <Link href="/blog" className="text-link">blog</Link>, and a few demos in the <Link href="/portfolio" className="text-link">portfolio</Link>.
            </p>
          </section>
          <section style={{ padding: "1rem 0" }}>
            <h2 style={{ marginBottom: "0.5rem" }}>Professional</h2>
            <p>
              Day job: scrum master and project manager. If you need that version of us, <a href="/resume/TuckerAustenScrumMaster.pdf" className="text-link font-medium underline hover:text-brand-accent" target="_blank" rel="noopener noreferrer">resume</a> and links below.
            </p>
    ...
    >
      <p>
        © 2025 Austen Tucker. Licensed under{" "}
