          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <tbody>
              ...
              <tr>
                ...
                <td style={{ padding: "10px", borderBottom: "1px solid var(--accent-color)" }}>
                  <p>I'm a full stack developer mostly working in Python, Javascript, and Next.js. My passion is building useful tools for the neurodivergent and blind communities. Check out my projects on my <Link href="/blog" className="text-link">blog</Link>.</p>
                </td>
              </tr>
              <tr>
                <td style={{ padding: "10px", borderBottom: "1px solid var(--accent-color)" }}>
